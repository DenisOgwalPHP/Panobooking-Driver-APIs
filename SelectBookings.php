...
$sql1="SELECT Cost,OrderCode,Date,Facility,Quantity,User,DatesFrom,DatesTo,Taken FROM cart where ProductName ='".$taxinos."' and Booked='Yes' and Confirmed='Confirmed' and Taken='No' order by IDs Desc";
