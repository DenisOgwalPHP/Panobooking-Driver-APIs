...
$sql1="SELECT Cost,OrderCode,Date,Facility,Quantity,User,DatesFrom,DatesTo,Taken FROM cart where ProductName ='".$taxinos."' and Booked='Yes' and Confirmed='Pending' order by IDs Desc";
...
if (mysqli_num_rows($result1) >= 1) {
    ...
    $response1 = array();
    $messages = 'No Schedule Found for this Vehicle so Far';
